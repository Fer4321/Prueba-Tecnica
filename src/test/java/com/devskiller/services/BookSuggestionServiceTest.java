...
//	Additional test:
	...
	@Test
	public void shouldNotSuggestBooksWhenNoReadersOfSameAge() {
	    // given:
	    Reader newReader = new Reader(200); // Edad única, sin lectores iguales
	...
	@Test
	public void shouldNotSuggestBooksWhenReaderHasNoFavouriteGenres() {
	    // given:
	...
	@Test
	public void shouldNotSuggestBooksWhenNoBooksMatchExactRating() {
	    // when:
	    Set<String> suggestedBooks = suggestionService.suggestBooks(reader1, 2);
	...
	@Test
	public void shouldNotSuggestBooksWhenNoBooksOfGivenAuthorMatch() {
	    // given:
	    Author unknownAuthor = new Author("Unknown", "Author");

	    // when:
	    Set<String> suggestedBooks = suggestionService.suggestBooks(reader1, unknownAuthor);
